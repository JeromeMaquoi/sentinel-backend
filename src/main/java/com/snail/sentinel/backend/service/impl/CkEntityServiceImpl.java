...
public class CkEntityServiceImpl implements CkEntityService {
    ...
    @Override
    public List<CkEntity> findByCommitShaAndMethodElement(String sha, String className, String methodSignature) {
        return ckEntityRepository.findByCommitShaAndMeasurableElementClassNameAndMeasurableElement_MethodSignature(sha, className, methodSignature);
    }
