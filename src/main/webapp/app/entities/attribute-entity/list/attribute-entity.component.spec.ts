...
import { sampleWithRequiredData } from '../attribute-entity.test-samples';
...
describe('AttributeEntity Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [AttributeEntityComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.attributeEntities?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to attributeEntityService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getAttributeEntityIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAttributeEntityIdentifier).toHaveBeenCalledWith(entity);
